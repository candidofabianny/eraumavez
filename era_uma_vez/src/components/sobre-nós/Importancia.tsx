...
const Importancia = () => {
  return ( 
    <section
      id="importancia"
      className="bg-[#D4FBFF]/50 flex flex-col justify-center min-h-[420px] w-full">
        <div className="flex flex-col items-center justify-center">
          <p className="text-purple mx-10 lg:max-w-[900px] text-center md:text-left text-[1.1rem] md:text-[1.45rem]">
