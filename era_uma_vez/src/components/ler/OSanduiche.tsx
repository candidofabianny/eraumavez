  ...
  return ( 
    <section
      ...
      className="bg-[#D4FBFF]/50 flex flex-col justify-center min-h-[710px] w-full">
        ...
        <Viewer
          fileUrl="assets\pdf\o-sanduíche-da-maricota.pdf"
          ...
          A galinha Maricota preparou um sanduíche. Mas, antes de conseguir comer, a bicharada toda começou a chegar e dar palpite para tornar o sanduíche da Maricota mais gostoso - para eles, é claro.</p>
          <Link href="/ler">
